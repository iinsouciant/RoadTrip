...
class PinCanvas(ctk.CTkCanvas):
    def __init__(self, master, font, size, **kwargs):
        ...
        self.locations = {}
        self.locations[self.create_image(30, 30, image=self.pinImg, anchor='nw')] = (30, 30)
        self.locations[self.create_image(30, 35, image=self.pinImg, anchor='nw')] = (30, 65)
